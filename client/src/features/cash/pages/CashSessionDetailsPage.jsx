  ...
  if (!sessionData?.data) {
    return (
      <div className="text-center py-12">
        ...
        <Button variant="outline" className="mt-4" onClick={() => navigate("/cash/sessions")}>
          Back to Sessions
        </Button>
      </div>
    );
    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-4">
          <Button variant="ghost" size="sm" onClick={() => navigate("/cash/sessions")}>
        ...
        <div className="flex gap-2">
          {session.status === "OPEN" && (
            <>
              ...
              <Button variant="outline" onClick={() => navigate(`/cash/sessions/${id}/payments/new`)}>
